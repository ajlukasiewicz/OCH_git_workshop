...
2. To do this, I'll click "pull requests."
3. The "test" branch also contains this text, not initially present in the README of Alex's "main" branch. This will create a merge conflict, which we will resolve.
...
2. To make changes to the R script, I will make a local clone of the repository. I'll do this on the command line, but it can also be down via the "download" button.
